...
const SvgColorPaletteOutline = (props: SVGProps<SVGSVGElement>, ref: Ref<SVGSVGElement>) => (
  ...
  >
    <g clipPath={'url(#color-palette-outline_svg__a)'} fill={'currentColor'}>
      ...
      <path
        d={
          'M12 8a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3M15.25 7.2a1.5 1.5 0 1 0 1.501 2.599A1.5 1.5 0 0 0 15.25 7.2M8.75 7.2a1.5 1.5 0 1 0-1.498 2.6A1.5 1.5 0 0 0 8.75 7.2M6.16 11.26a1.5 1.5 0 1 0 2.08.4 1.49 1.49 0 0 0-2.08-.4'
        }
      />
    </g>
    <defs>

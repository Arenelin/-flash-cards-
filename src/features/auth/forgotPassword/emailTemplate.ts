  ...
  <table style="border-collapse:collapse;border-spacing:0;max-width:600px;width:100%;margin: 0 auto;">
    <tr>
      <td style="border-radius:25px;color:#ffffff;padding:20px;background-color:#bea6ff" >
        <img style="float:left;margin-right:20px;border-radius:10px;width:100px:height:100px" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRS7trqI1p3zximPfE3gm9QUio42NKBfa5xlQoLgCcTYSBH3ZO4x6S3K4-mf1BlZNrgz6Q&usqp=CAU"/>
        <p style='margin: 0'>
        ...
        <p></p>
        <h3 style="color:#cc1439;text-align:center">
